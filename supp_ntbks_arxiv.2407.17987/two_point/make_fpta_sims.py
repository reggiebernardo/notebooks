...
def make_fpta_sims(npsrs=100, Tobs=30, ntoas=100, toaerr=1e-7, \
                   ...
                   add_white=False, save_pickle=False, pkl_file='my_pickle'):
    ...
    for psr in psrs:
        ...
        if add_red:
            log10_A_min=rn_input_dict['log10_A_min']
            log10_A_max=rn_input_dict['log10_A_max']
            gamma_min=rn_input_dict['gamma_min']
            gamma_max=rn_input_dict['gamma_max']
            psr.add_red_noise(spectrum='powerlaw', \
                              log10_A=np.random.uniform(log10_A_min, log10_A_max), \
